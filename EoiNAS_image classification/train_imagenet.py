...
def main():
  ...
  #logging.info("params = %fMB", params/1e6)
  #logging.info("flops = %fMB", flops/1e6)
  ...
  #checkpoint = torch.load('/media/lab540/disk3/GNAS2-ImageNet/eval_imagenet-20191025-200725/checkpoint.pth.tar')
